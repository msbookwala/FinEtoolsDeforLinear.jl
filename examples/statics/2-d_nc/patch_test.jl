...
if left_m == "t"
    ...
    Rule1 = TriRule(1)
    exporter1 = FinEtools.MeshExportModule.VTK.T3
else
    fens1, fes1 = Q4block(width1, height1, floor(Int, N_elem1/2), N_elem1)
    Rule1 = GaussRule(2,2)
    exporter1 = FinEtools.MeshExportModule.VTK.Q4
end
...
if right_m == "t"
    ...
    Rule2 = TriRule(1)
    exporter2 = FinEtools.MeshExportModule.VTK.T3
else
    fens2, fes2 = Q4block(width2, height2, floor(Int, N_elem2/2), N_elem2)
    Rule2 = GaussRule(2,2)
    exporter2 = FinEtools.MeshExportModule.VTK.Q4
end
