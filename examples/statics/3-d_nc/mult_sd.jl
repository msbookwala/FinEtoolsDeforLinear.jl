...
if !isdir("mult_sd")
    ...
    for file in readdir("mult_sd")
        rm(joinpath("mult_sd", file))
    end
end
    ...
    for yi in 1:2
        for xi in 1:2
            ...
            for i in 1:3
                ...
                # filename = "mult_sd/union_$(index)_$(i).vtk"
                # vtkexportmesh(
                #     filename,
                #     meta["fens_u"],
                #     meta["fes_u"];
...
for i in 1:3
    ...
    filename = "mult_sd/mesh_interface_$(i).vtk"
            vtkexportmesh(
                filename,
                fens_is[i],
                fes_is[i];
