...
if !isdir("curved_mult_sd")
    mkdir("curved_mult_sd")
else
    for file in readdir("curved_mult_sd")
        rm(joinpath("curved_mult_sd", file))
    end
end
...
for i in 1:3
    ...
    fn = "curved_mult_sd/interface_$(i).vtk"
    # vtkexportmesh(
    #     fn,
    #     fens_i,
    #     fes_i;
...
for i in 1:8
    ...
    filename = "curved_mult_sd/mesh_$(i).vtk"
            vtkexportmesh(
                filename,
                fens_list[i],
                fes_list[i];
...
for i in 1:3
    ...
    filename = "curved_mult_sd/mesh_interface_$(i).vtk"
            vtkexportmesh(
                filename,
                fens_is[i],
                fes_is[i];
